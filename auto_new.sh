...
CUDA_VISIBLE_DEVICES=2 python Fed_deltaLora.py --lr 5e-5 --select_method ours --select_layer_num 32 --path ./flearn/configs/ours/mrpc.json | tee ./res/deltalora/mrpc.txt
