...
from models.modeling_llama_v2 import LlamaForSequenceClassification
import copy
import os
import time
...
class CentralTraining(object):
    ...
    def load_model(self):
        ...
        if "llama" in self.args.model_name_or_path:
            ...
            config.prefix_projection = self.args.prefix_projection
            config.hidden_dropout_prob = self.args.hidden_dropout_prob
            config.pre_seq_len = self.args.num_prompt_tokens
            config.prefix_hidden_size = self.args.prefix_hidden_size
