...
class RobertaEncoder(nn.Module):
    ...
    def update_r(self, layer_list):

        for i in range(self.config.num_hidden_layers):
            if i in layer_list:
                self.layer[i].attention.self.query.r = self.config.lora_r
            else:
                self.layer[i].attention.self.query.r = 0
...
class RobertaForMaskedLM(RobertaPreTrainedModel):
    ...
    def get_embeddings_only(
        ...
        outputs = self.roberta.forward_embedding(
            input_ids,
            attention_mask=attention_mask,
            token_type_ids=token_type_ids,
            position_ids=position_ids,
    ...
    def get_output_for_embeddings(
        ...
        outputs = self.roberta.forward_encoder(
            input_ids,
            attention_mask=attention_mask,
            token_type_ids=token_type_ids,
            position_ids=position_ids,
